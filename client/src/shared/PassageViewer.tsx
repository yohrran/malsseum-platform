...
export const PassageViewer = ({ bookAbbr, chapters, label, onClose }: Props) => {
  ...
  return (
    ...
    >
      <div
        className="flex h-[92vh] w-full max-w-2xl flex-col rounded-t-3xl bg-white shadow-2xl sm:h-[85vh] sm:rounded-2xl"
      ...
      >
        ...
        <div className="flex shrink-0 items-center justify-between border-b border-stone-100 px-5 py-4">
          ...
          <div className="ml-3 flex items-center gap-0.5">
            ...
            <button
              onClick={onClose}
              className="ml-1 flex h-8 w-8 items-center justify-center rounded-full text-stone-400 transition-colors hover:bg-stone-100 hover:text-stone-600"
              aria-label={t.close}
            >
              <svg
        ...
        <div ref={contentRef} className="flex-1 overflow-y-auto px-5 py-5">
          ...
          {data && activeChapter && (
            <div>
              <p className="mb-4 text-xs font-bold tracking-widest text-stone-400">
