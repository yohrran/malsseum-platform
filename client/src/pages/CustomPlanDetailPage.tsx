...
export const CustomPlanDetailPage = () => {
  ...
  return (
    <div className="space-y-5 pb-6">
      ...
      {/* 시즌 탭 */}
      <div className="flex gap-0.5 overflow-x-auto border-b border-slate-100">
        ...
        <>
          ...
          <div className="rounded-2xl border border-slate-100 bg-white p-5 shadow-sm">
            <div className="mb-3 flex items-center justify-between">
              <p className="text-sm font-medium text-slate-600">{activeSeason.label}</p>
            ...
            {activeSeason.days.map((day, dayIdx) => (
              <li key={dayIdx} className="flex items-center gap-3 px-4 py-3.5">
                ...
                <button
                  ...
                  className="flex h-8 shrink-0 items-center rounded-lg px-3 text-xs font-medium text-indigo-500 transition-colors hover:bg-indigo-50 active:bg-indigo-100"
                >
                  {t.viewPassage}
                </button>
              </li>
