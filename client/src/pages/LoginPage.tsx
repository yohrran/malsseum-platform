    ...
    <>
      ...
      <div className="relative flex min-h-screen flex-col items-center justify-center bg-stone-50 dark:bg-stone-800 px-5">
        ...
        <div className="relative z-10 flex w-full max-w-sm flex-col items-center">
          ...
          <p className="mt-2 text-sm text-stone-400 dark:text-stone-500">함께 성경을 읽어요</p>

          {/* Scripture */}
          <blockquote className="mt-8 rounded-2xl bg-white dark:bg-stone-800 px-6 py-5 text-center ring-1 ring-stone-200/60 dark:ring-stone-700/60">
